...
describe('Call hook', function () {
    var hooksHelpers = proxyquire('../../../../../cartridges/app_storefront_base/cartridge/scripts/helpers/hooks', {
        'dw/system/HookMgr': {
            hasHook: hasHookSpy,
    ...
    it('should call hook without parameter', function () {
        var definedHook = proxyquire('../../../../../cartridges/app_storefront_base/cartridge/scripts/helpers/hooks', {
            'dw/system/HookMgr': {
                hasHook: function () {
                    return true;
                },
